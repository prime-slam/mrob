...
#ifndef FACTOR2BIAS3D_HPP_
#define FACTOR2BIASK3D_HPP_
...
class Factor2Bias3d : public Factor
{
  public:
    Factor2Bias3d(const Mat31 &observation,
                std::shared_ptr<Node> &n1,
                std::shared_ptr<Node> &n2,
                const Mat3 &obsInf,
                Factor::robustFactorType robust_type = Factor::robustFactorType::QUADRATIC);
    ~Factor2Bias3d() = default;
    /**
