...
Factor1Pose3dVel::Factor1Pose3dVel(const Mat4 &observation, std::shared_ptr<Node> &n1,
...
void Factor1Pose3dVel::evaluate_residuals()
{
...
void Factor1Pose3dVel::evaluate_jacobians()
{
...
void Factor1Pose3dVel::print() const
{
