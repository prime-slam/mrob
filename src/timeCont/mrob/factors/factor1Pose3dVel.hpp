...
/**
 * The Factor1Poses3dVel is based on factor1Pose3dVel, but neglecting the velocity part of SE3tc
 * It is a vertex representing the distribution
...
class Factor1Pose3dVel : public Factor
{
  public:
    Factor1Pose3dVel(const Mat4 &observation, std::shared_ptr<Node> &n1, const Mat6 &obsInf,
            Factor::robustFactorType robust_type = Factor::robustFactorType::QUADRATIC);
    Factor1Pose3dVel(const SE3 &observation, std::shared_ptr<Node> &n1, const Mat6 &obsInf,
            Factor::robustFactorType robust_type = Factor::robustFactorType::QUADRATIC);
    ~Factor1Pose3dVel() = default;
    /**
