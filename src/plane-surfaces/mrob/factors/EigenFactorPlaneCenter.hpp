...
protected:
    ...
    Mat4 accumulatedQ_,accumulatedCenterQ_;//Q matrix of accumulated values for the incremental update of the error.
    Mat4 Tcenter_;

    Mat41 planeEstimation_, planeEstimationUnit_;
