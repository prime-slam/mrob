...
Factor1Landmark3d::Factor1Landmark3d(const Mat31 &observation, std::shared_ptr<Node> &n1,
...
void Factor1Landmark3d::evaluate_jacobians()
{
    // Evaluate Jacobian
    J_ = Mat3::Identity();
}

void Factor1Landmark3d::evaluate_residuals()
{
    r_ = get_neighbour_nodes()->at(0).get()->get_state() - obs_;
}

void Factor1Landmark3d::evaluate_chi2()
{
    chi2_ = 0.5 * r_.dot(W_ * r_);
}

void Factor1Landmark3d::print() const
{
