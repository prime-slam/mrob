 ...
 *
 *
 * factorCameraProj3dPointSim3.hpp
 *
...
#ifndef FACTORCAMERAPROJ3DPOINTSIM3_HPP_
#define FACTORCAMERAPROJ3DPOINTSIM3_HPP_
...
/**
 * The FactorCameraProj3dPointSim3 is a vertex representing the distribution between
 * a Sim3 Transformation encoding a 3D pose (with scale) and a Landmark, a 3D point
...
class FactorCameraProj3dPointSim3 : public Factor
{
  public:
    FactorCameraProj3dPointSim3(const Mat21 &observation, std::shared_ptr<Node> &nodePose,
            std::shared_ptr<Node> &nodeLandmark,
            const Mat41 &camera_k,
            const Mat2 &obsInf = Mat2::Identity(),
            Factor::robustFactorType robust_type = Factor::robustFactorType::QUADRATIC);
    ~FactorCameraProj3dPointSim3() = default;
    /**
  ...
  protected:
    ...
    Mat<2,10> J_;//Joint Jacobian: 7 (pose+scale) + 3(point) || + 4 (K)
...
#endif /* FACTORCAMERAPROJ3DPOINTSIM3_HPP_ */