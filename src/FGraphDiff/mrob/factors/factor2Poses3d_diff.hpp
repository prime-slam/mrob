...
#ifndef FACTOR2POSES3D_DIFF_HPP_
#define FACTOR2POSES3D_DIFF_HPP_
...
class Factor2Poses3d_diff : public DiffFactor
{
  public:
    Factor2Poses3d_diff(const Mat4 &observation, std::shared_ptr<Node> &nodeOrigin,
            std::shared_ptr<Node> &nodeTarget, const Mat6 &obsInf, bool updateNodeTarget=false,
            Factor::robustFactorType robust_type = Factor::robustFactorType::QUADRATIC);
    Factor2Poses3d_diff(const SE3 &observation, std::shared_ptr<Node> &nodeOrigin,
            std::shared_ptr<Node> &nodeTarget, const Mat6 &obsInf, bool updateNodeTarget=false,
            Factor::robustFactorType robust_type = Factor::robustFactorType::QUADRATIC);
    ~Factor2Poses3d_diff() = default;
    /**
...
#endif /* FACTOR2POSES3D_DIFF_HPP_ */
