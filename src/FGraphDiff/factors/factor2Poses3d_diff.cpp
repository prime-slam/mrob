...
Factor2Poses3d_diff::Factor2Poses3d_diff(const Mat4 &observation, std::shared_ptr<Node> &nodeOrigin,
        std::shared_ptr<Node> &nodeTarget, const Mat6 &obsInf, bool updateNodeTarget,
        DiffFactor::robustFactorType robust_type):
        DiffFactor(6,12,robust_type), Tobs_(observation), W_(obsInf)
{
...
Factor2Poses3d_diff::Factor2Poses3d_diff(const SE3 &observation, std::shared_ptr<Node> &nodeOrigin,
        std::shared_ptr<Node> &nodeTarget, const Mat6 &obsInf, bool updateNodeTarget,
        DiffFactor::robustFactorType robust_type):
        DiffFactor(6,12, robust_type), Tobs_(observation), W_(obsInf)
{
...
void Factor2Poses3d_diff::evaluate_residuals()
{
...
void Factor2Poses3d_diff::print() const
{
