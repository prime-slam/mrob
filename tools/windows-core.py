...
# export build/mrobTargets.cmake instead of recompiling them.
import subprocess

if __name__ == "__main__":
    subprocess.run(["cmake", "-B", "build", "-DBUILD_PYTHON_BINDINGS=OFF"], check=True)
    subprocess.run(["cmake", "--build", "build", "--config", "Release", "--parallel"], check=True)
